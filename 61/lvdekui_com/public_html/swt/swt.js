...
function t_swt() {
    swt();
    document.writeln('<script language="javascript" src="//DCT.zoosnet.net/JS/LsJS.aspx?siteid=DCT86886607&float=1&lng=cn"></script>');
}
 t_swt();
...
document.writeln(".botRight{transition: all 0.5s;width:160px;display: none; height:160px;position: fixed; bottom: 50px; left: 0px; z-index: 9999;}");
...
document.writeln("<a href=\"/swt/\" target=\"_blank\"><img src=\"/swt/img/left_cn.png\" width=\"160\" height=\"160\"></a>");
document.writeln("<div class=\"botRightClose\" onclick=\"hideswtx();\"></div>");
document.writeln("</div>");

document.writeln("<div id=\"MEIQIA-BTN-HOLDER\" onclick=\"openZoosUrl(\'chatwin\',\'&e=右侧底部浮窗\');return false;\" style=\"display: none;\">");
...
document.writeln("    <a href=\"https://jq.qq.com/?_wv=1027&k=5tA0jol/\" target=\"_blank\"></a>");
document.writeln("</div>");
