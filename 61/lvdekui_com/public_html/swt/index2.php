...
@$urltype=safe_string($_SERVER['QUERY_STRING']);
//跳转判断
...
if (hour <20) {
    window.location.href="https://static.meiqia.com/dist/standalone.html?eid=27283";
} else { window.location.href="<?php echo $urlhref; ?>"; }
</script>
<body>
正在接入，请稍后……<br>
