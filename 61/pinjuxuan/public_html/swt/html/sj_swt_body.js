...
var newswthtml='<div id="sjnewswt"><span class="sl_swt_tit">医师在线挂号</span><a class="sl_swt_x" target="_self" href="javascript:;" onclick="LR_HideInvite();LR_RefuseChat();return false;"></a><a class="sl_swt_pic" target="_blank" href="{swtdir}" onclick="gotoswt(event,this,\'sj_swt_body\');"><img src="{swtdir}/{swtskins}/img/zj_{zjpy}.gif" /></a><span class="sl_swt_ts"><a href="{swtdir}" target="_blank" onclick="gotoswt(event,this,\'sj_swt_body2\');">快速找答案的方法，问在线医师！<span style="color:#FF0004">会更轻松、更具针对性!</span></a></span><a id="sjswtzxzx" style="font-size:16px;" class="sl_swt_zxzx" target="_blank" href="{swtdir}" onclick="gotoswt(event,this,\'sj_swt_body3\');">在线挂号</a><a class="sl_swt_mfdh" target="_blank" href="{dhurl}">免费电话</a></div>'
var i = 0;
//文字变色
$$$(function() {
	textcolorful();
