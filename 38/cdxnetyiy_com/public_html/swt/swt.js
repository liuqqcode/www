...
/*离线宝开始*/
// document.write('<script type="text/javascript"  data-lxb-uid="11180952" data-lxb-gid="196737" src="http://lxbjs.baidu.com/api/asset/api.js?t=' + new Date().getTime() + '" charset="utf-8"></scr' + 'ipt>');
...
var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");document.write(unescape("%3Cspan id='cnzz_stat_icon_1261122148'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s95.cnzz.com/z_stat.php%3Fid%3D1261122148' type='text/javascript'%3E%3C/script%3E"));
document.write("</div>");
(function(e) {
    e.fn.fix = function(t) {
...
$(document).ready(function() {
    $(document).ready(function() {
        $("#sidebar ul li").hover(
            function() {
                $(this).find(".sidebox").stop().animate({ "width": "145px" }, 200).css({ "opacity": "1", "filter": "Alpha(opacity=100)", "background": "#923222" });
                $(this).find(".sidebox i").attr({ "class": $(this).find(".sidebox i").attr("class") + "_s" });
            },
            function() {
                $(this).find(".sidebox").stop().animate({ "width": "72px" }, 200).css({ "opacity": "1", "filter": "Alpha(opacity=100)", "background": "#923222" });
        ...
        $("#sidebar ul li").hover(
            function() {
                $(this).find(".sidebox2").stop().animate({ "width": "400px" }, 200).css({ "opacity": "1", "filter": "Alpha(opacity=100)", "background": "#923222" });
                $(this).find(".sidebox2 i").attr({ "class": $(this).find(".sidebox i").attr("class") + "_s" });
            },
            function() {
                $(this).find(".sidebox2").stop().animate({ "width": "72px" }, 200).css({ "opacity": "1", "filter": "Alpha(opacity=100)", "background": "#923222" });
...
document.writeln("#sidebar{position:fixed;z-index:11; top:60px;right:10px;display:none!important}");
...
document.writeln(".top{ background:url(/swt/img/toph.png) no-repeat;}");
...
document.writeln("#sidebar ul li .sidebox{position:absolute;width:72px;height:72px;top:0;right:0px;transition:all 0.3s;background:#a47049;opacity:1;filter:Alpha(opacity=100);color:#fff;font:14px/72px \"Microsoft YaHei\";overflow:hidden;}");
document.writeln("#sidebar ul li span{ position:relative;left:8px}");
document.writeln("#sidebar ul li#swtrightzx .sidebox{background:#a47049 !important;}");
document.writeln("</style>");
