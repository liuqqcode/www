...
//左侧免费电话js
document.getElementById("callBtnm").onclick = function () { 
lxb.call(document.getElementById("telInputm"));
};
...
//+"			<div class=\"bd\">"
//+"				<ul>"
//+"					<li><a href=\"{swtdir}\" target=\"_blank\" onclick=\"gotoswt(event,this,'pc_swt_bottom1');\">湖南网友：多动症诊治需要多少钱？</a></li>"
//+"					<li><a href=\"{swtdir}\" target=\"_blank\" onclick=\"gotoswt(event,this,'pc_swt_bottom2');\">湖南网友：抽动症怎样诊治好？</a></li>"
//+"					<li><a href=\"{swtdir}\" target=\"_blank\" onclick=\"gotoswt(event,this,'pc_swt_bottom3');\">江浙网友：遗尿症有什么诊治好方法？</a></li>"
//+"					<li><a href=\"{swtdir}\" target=\"_blank\" onclick=\"gotoswt(event,this,'pc_swt_bottom4');\">湖南网友：怎么诊治智力低下效果好？</a></li>"
//+"					<li><a href=\"{swtdir}\" target=\"_blank\" onclick=\"gotoswt(event,this,'pc_swt_bottom5');\">安徽网友：自闭症诊治好的方法是什么？</a></li>"
//+"					<li><a href=\"{swtdir}\" target=\"_blank\" onclick=\"gotoswt(event,this,'pc_swt_bottom6');\">浙江网友：怎样诊治遗尿症省钱？</a></li>"
//+"				</ul>"
//+"			</div>"
//+"		</div>"
//+"	</div>"
