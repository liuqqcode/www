...
var LiveAutoInvite2='如果您有什么问题,请点击此处与医师进行即时沟通！';
...
document.writeln("     <a href=\"/qwjs/\" target=\"_blank\">诊治方案</a>");
document.writeln("     <a href=\"/dxal/\" target=\"_blank\">诊治案例</a>");
document.writeln("     <a href=\"/zjtd/\" target=\"_blank\">医师介绍</a>");
...
document.writeln('	<a target="_blank" href="javascript:void(0);return false;" onclick="openZoosUrl();return false;"></a>');
document.writeln('</div>');
