...
/*****************************/
//左侧边栏HTML
//swtleftBannerHTML='<a href="javascript:;" target="_self" onclick="closeWin(this);return false;" class="sl_Banner_close"></a><a class="telbeijing" target="_blank" href="javascript:void(0);return false;" onclick="openZoosUrl();return false;"></a>';
...
$("#sidebar").css({'top':top});
	...
	/*
	var $offset = $('.right_bottom').offset();
	if($(window).scrollTop()>($offset.top)-300){
		$('.right_fix').css({'position':'fixed','top':'25px','left':$offset.left+'px','z-index':'1'});
		$('.TB-focus3').css({'position':'absolute',});
		}else{
		$('.right_fix').removeAttr('style');
...
document.writeln("<style>");
document.writeln(".kfzl_fixed{ position:fixed;left:3px;top:20%;z-index:10001;}");
document.writeln("</style>");
document.writeln("<div class=\"kfzl_fixed\">");
document.writeln("<a href=\"javascript:void(0)\" onclick=\"openZoosUrl('chatwin','&amp;e=左侧浮窗');return false;\" target=\"_blank\">><img src=\"/swt/html/img/zuoce.png\"/></a>");
document.writeln("</div>");
