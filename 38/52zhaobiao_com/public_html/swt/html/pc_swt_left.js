...
(function(e) { e.fn.fix = function(t) {
        ...
        this.each(function() {
            ...
            n.css(t.float, 0), t.minStatue && (e(".show_btn").css("float", t.float), s.css("width", 0), i.css("width", 25)), t.skin && n.addClass("side_" + t.skin), e(window).bind("scroll", function() {
                ...
                n.animate({ top: r }, { duration: t.durationTime, queue: !1 }) }), r.bind("click", function() { s.animate({ width: "0" }, "fast"), i.stop(!0, !0).delay(300).animate({ width: "33px" }, "fast").css("float", "left") }), i.click(function() { e(this).animate({ width: "0px" }, "fast"), n.width(o), s.stop(!0, !0).delay(200).animate({ width: "167px" }, "fast") }) }) } })(jQuery)
...
$(function() {
    ...
    window.onscroll = function() {
        ...
        document.getElementById('Oclose').onclick = function() {
            document.getElementById('fotBox').style.display = "none";
            isSc = true;
        };
...
document.writeln("#sidebar{position:fixed;z-index:100001; top:30px;right:10px;}");
...
document.writeln("#sidebar ul li i.top2{ width:72px; height:72px; margin-top:0}");
...
document.writeln(".top2{ background:url(/swt/img/top.png) no-repeat;}");
...
document.writeln(".dx_s{ background:url(/swt/img/dx_s.png) no-repeat center center; width:44px; height:38px}");
...
document.writeln("         <li><a href=\"tencent://message/?uin=884627559&Site=xinanertong&Menu=yess\" target=\"_blank\">");
...
document.writeln("<style>");
document.writeln(".kfzl_fixed{position:fixed; left:3px;top:20%;}");
document.writeln(".div1{z-index:10001; background:url(/swt/html/img/zuoce1.png) no-repeat; width:180px; height:238px;}");
document.writeln(".div2{ width:165px; height:103px;margin-top:108px; margin-left: 1px;}");
document.writeln(".div3{ width:23px; height:25px;margin-top:0px; margin-left:154px;}");
document.writeln("</style>");
document.writeln("<div class=\"kfzl_fixed\">");
document.writeln("<div class=\"div1\" id=\"div1\">");
document.writeln("<a href=\"javascript:show('div1')\"><div class=\"div3\"></div></a>");
document.writeln("<a href=\"http://zg.xnekyy.cn/gljc/\"  target=\"_blank\" onclick=\"_czc.push(['_trackEvent', 'left', '左侧浮窗', 'gljc']);\"><div class=\"div2\"></div></a>");
