...
$info = array(
	...
	"lr_next_invite_seconds" => 10, //商务通邀请框关闭后再次弹出时间（秒）
	"imgwhat" => 0, //默认显示图片数组列（从0开始，涉及文件showimg.php）

	/*	信息设置	*/
	"web" => "成都西南儿童医院", //网站名称
	"yy" => "成都西南儿童医院", //医院名称
	"swtid" => "DCT83520618", //商务通ID
	/*	"swtid" => "DCT57598962",*/
	"qq" => "884627559", //QQ号码
	"dh" => "028-84319120", //电话号码
	"tel" => "/mfdh/", //免费电话连接
	"dz" => "湖南省长沙市开福区八一路546号（长沙市博物馆旁）", //医院地址
	"zj" => "付诗亭", //主推医师名称
	"zjjj" => "1983年蒋兆瑜于湖南医科大学毕业后穿上白大褂，1993年至1997年，蒋兆瑜先后进入中国人民解放军一军医大学和华西医院小儿神经科进修，主攻儿童多动症抽动症等儿童神经系统疾病。", //主推医师简介
	"zjurl" => "/lanmu/zj/311.html", //主推医师连接
