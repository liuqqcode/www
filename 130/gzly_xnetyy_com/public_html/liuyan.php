...
//留言后台
$fromurl = "http://gzly.xnetyy.com/huaqiao.php"; //跳转往这个地址。
...
if (isset($_POST['yc'])) {
	...
	if (count($arr) > 0) {
		...
		header("Location: http://gzly.xnetyy.com/liuyan.php");
	} else {
...
$wgzhi = $value['address'];
	...
	if ($bs === 'klszxyy.com' || $wgzhi2 === 'klszxyy.com' || $bs === 'gzrc120.com' || $bs === 'gzrc120.cn' || $bs === 'gzrc120.net' || $bs === 'gzrcyy.cn' || $bs === 'gzrcyy.net') {
		echo '竞价';
	} else {
		echo '外围';
	}
