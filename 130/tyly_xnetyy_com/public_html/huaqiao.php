...
if ($name) {
	...
	if (!empty($rows)) {
		echo "<script>window.location.href='http://tyly.xnetyy.com/liuyan.php'</script>";

	} else {
		echo "<script>alert('帐号密码错误');</script>";
		echo "<script>window.location.href='http://tyly.xnetyy.com/huaqiao.php'</script>";
	}
}
?>
