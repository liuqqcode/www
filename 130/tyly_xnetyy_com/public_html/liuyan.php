...
//留言后台
$fromurl = "http://tyly.xnetyy.com/huaqiao.php"; //跳转往这个地址。
if ($_SERVER['HTTP_REFERER'] == "") {
	header("Location:" . $fromurl);exit;
}
$db = mysqli_connect('localhost', 'tyly_xnetyy_com', 'dpFxtND181lI', 'tyly_xnetyy_com');
...
if (isset($_POST['yc'])) {
	...
	if (count($arr) > 0) {
		...
		header("Location: http://tyly.xnetyy.com/liuyan.php");
	} else {
...
<!--弹出框-->
<div class="bo_xg" id="bo_xg" onmousedown="MoveDiv.Move('bo_xg')">
   <div class="bo_zx"><p>留言详情(此框可拖动，内容查看不全时请点击黑色条拖动)</p><a href="javascript:yinc(1);" ><img src="index/xx.jpg"/></a></div>
   <div class="box_sc">
      <div>序号</div>
...
<div class="index_ly">
  <p>待诊预约表单留言后台</p>
  <p><a href="http://tyly.xnetyy.com">注销</a></p>
</div>
...
$wgzhi = $value['address'];
	...
	if ($bs === 'tywybbyy.com' || $bs === 'tyzxyy.net' || $bs === 'tyzx120.net') {
		echo '竞价';
	} else {
		echo '外围';
	}
