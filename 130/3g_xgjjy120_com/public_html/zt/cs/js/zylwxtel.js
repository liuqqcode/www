...
$(function(){
	...
	var warr=[];
	var wxtel=[{'tel':'<div class="input-group"><input type="text" id="telname" value="" placeholder="请填写您的电话号码" autofocus="autofocus"><button class="tel" id="telbtn" index="11">提交</button></div>'},{'wx':'<div class="input-group1"><a href="javascript:;"><p id="table"><img src="images/weixin.png" style="vertical-align: middle;margin-right: 30px;" width="50"><input type="" id="inputText" value="xgjjy0001" readonly=""><span>←点击复制微信号</span></p></a></div>'}]
	...
	var qJson=[
		...
		{'q':['您已完成全部自测答题，请选择获取测评结果的方式。','您已完成全部自测答题，请选择获取测评结果的方式。']}
		]
		...
		text[0]='您选择的是【电话获取结果】，请在下方输入框内留下您的手机号码，24小时之内老师给出评测结果并与您取得联系！如有疑问可拨打热线：<a href="tel:4001126388" style="color:red;">400-112-6388</a>直接电话咨询！';
		text[1]='您选择的是【微信获取结果】，请添加老师微信<span style="color:red;">xgjjy0001</span>获取测评结果，并获得训练方法和专业建议。如有疑问可拨打热线：<a href="tel:4001126388" style="color:red;">400-112-6388</a>直接电话咨询！';

		text[2]='您的联系方式我们已收到，稍后我们会通知您自测分析检的测结果，请耐心等待！';
		...
		btnarr[9]='<div class="btnbox w50"><button class="btn" index="10" wtindex="9" isc="1">电话</button></div><div class="btnbox w50"><button class="btn" index="10" wtindex="9" isc="0">微信</button></div>';



		btnarr[10]='';

		btnarr[11]='<ul class="lsbtn">';

		btnarr[11]+="<li>您已提交成功！我们将尽快与您联系！请保持电话畅通！</li>";
	...
	$("#wdfixbom .btn").live('click',function(){
		...
		setTimeout(function(){
			if(wtindex<=qJson.length-1){
				...
				//判断是否已经结束并且在提示患者留电话还是微信
				if(clickNum==1){
					btnarr[index]=wxtel[0].tel;
					appyslt(text[0]);
				}else{
					btnarr[index]=wxtel[1].wx;
					appyslt(text[1]);
