...
$(function(){
	...
	var qJson=[
		...
		text[0]='您已完成全部自测答题，请在下方输入框内留下您的手机号码，24小时之内老师给出评测结果并与您取得联系！如有疑问可拨打热线：<a href="tel:4001126388" style="color:red;">400-112-6388</a>直接电话咨询！';
		...
		btnarr[9]='<div class="input-group"><input type="text" id="telname" value="" placeholder="请填写您的电话号码" autofocus="autofocus"><button class="tel" id="telbtn" index="10">提交</button></div>';
