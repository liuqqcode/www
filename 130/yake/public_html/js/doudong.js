...
document.writeln("jQuery(\'#zd-win\').addClass(\'fadeInRight\');");
document.writeln("jQuery(\'#zd-close\').click(function(){");
document.writeln("    jQuery(\'#zd-win\').removeClass(\'fadeInRight\').fadeOut().addClass(\'fadeOutRight\');");
document.writeln("    setTimeout(function(){");
document.writeln("        jQuery(\'#zd-win\').removeClass(\'fadeOutRight\').fadeIn().addClass(\'fadeInRight\');");
...
document.writeln("        jQuery(\'#zd-win\').css( a[b%2] , (b++)%4<2?0:4 );");
