document.writeln('<script language="javascript" src="http://put.zoosnet.net/JS/LsJS.aspx?siteid=PUT94698938&float=1&lng=cn"></script>');
document.writeln("<link rel='stylesheet' href='http://4g.xnekyy.cn/swt/html/css/style.css'>"); //商务通样式
